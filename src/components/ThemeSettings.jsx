...
const ThemeSettings = () => {
  ...
  return (
    ...
    <p className='font-semibold text-xl'>Settin11gs</p>
    <button
    type='button'
    ...
    />
    <label htmlFor='light' className='mi-2 text-md cursor-pointer'>
      Light
    </label>
    </div>
    ...
    />
    <label htmlFor='dark' className='mi-2 text-md cursor-pointer'>
      Dark
    </label>
    </div>
    </div>
